...
def get_mol_fp(dataset_name):
    ...
    torch.save(fp_list, f"../data/{dataset_name}/{dataset_name}_mol_fp.pt")

def get_tanimoto(dataset_name):
    mol_fp = torch.load(f"../data/{dataset_name}/{dataset_name}_mol_fp.pt")
    ...
    torch.save(tanimoto_mat, f"../data/{dataset_name}/{dataset_name}_tanimoto.pt")

#get_mol_fp("drugbank")
#get_tanimoto("drugbank")

get_mol_fp("twosides")
get_tanimoto("twosides")